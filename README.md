...
First, [get the latest release](http://stg-bitbucket:7990/projects/DT/repos/twingrind/browse/release) of Twingrind, the download will give you a file called "twingrind_0.4.2.0.compiled-library" and a python setup file. Note that the version number may differ from the file you actually downloaded.
...
Open a command prompt and navigate to the *pytwingrind-0.4.2-py3-none-any.whl* file. Then use the following command to install the python module on your system.
Make sure that your python environment is reachable in your path variable.

```
pip install pytwingrind-0.4.2-py3-none-any.whl
```
